...
resource "aws_ec2_transit_gateway_vpc_attachment" "pca" {
...
resource "null_resource" "break_association_with_default_route_table" {
  ...
  depends_on = [
    aws_ec2_transit_gateway_vpc_attachment.pca,
  ]
